...
% ¤¤ Misc. ¤¤ %
%\usepackage[cache=false]{minted}			% Giver mulighed for at referer direkte til source kode filer. 
...
% ¤¤ Marginer ¤¤ %
\setlrmarginsandblock{1.5cm}{2.5cm}{*}		% \setlrmarginsandblock{Indbinding}{Kant}{Ratio}
...
\settocdepth{subsubsection} 				% Dybden af overskrifter vist i indholdsfortegnelsen
...
\makeoddhead{Uni}{\rightmark}{}{Aarhus Universitet}			% Ulige siders sidehoved (\makeoddhead{Navn}{Venstre}{Center}{Hoejre})
...
%newenviroment til Minted for linebreak
